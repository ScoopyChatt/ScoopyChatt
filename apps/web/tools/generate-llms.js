...
const PAGES = [
  ...
  ["/blog/multiple-dogs-yard-cleanup-chattanooga", "Two or Three Dogs? Multi-Dog Yard Cleanup in Chattanooga | Scoopy Doo", "How multiple dogs change yard cleanup in Chattanooga: how much waste to expect, how often to scoop, and what multi-dog pooper scooper service costs. Weekly from $20 a visit."],
  ["/blog/moving-to-chattanooga-with-a-dog", "Moving to Chattanooga With a Dog: New Resident Guide | Scoopy Doo", "New to Chattanooga with a dog? Local tips on neighborhoods, yard care, and pet waste rules, plus how professional dog poop removal makes settling in easier."],
  ["/blog/no-contact-pet-waste-removal-chattanooga", "Do You Need to Be Home for Dog Poop Removal? | Scoopy Doo Chattanooga", "No, Scoopy Doo does not require you to be home. How the no-contact pooper scooper service works in Chattanooga and North Georgia, with gate photos and on-the-way texts."],
