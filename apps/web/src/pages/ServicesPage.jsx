      ...
      <main className="flex-grow">
        ...
        <section className="py-20 px-4 bg-gradient-to-b from-primary/5 to-background text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-foreground mb-6 leading-tight">Pet Waste Removal Services</h1>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-card border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">Perfect for moving in or out, hosting an event, seasonal yard resets, or just trying us out before committing to regular service. Same thorough grid-pattern process as recurring visits — all waste removed from the property.</p>
              ...
              <div className="bg-card border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">If your yard has been unmanaged for weeks or months, we start with a thorough deep clean to get it back to baseline before beginning regular service. Overgrown yards and accumulated waste are never a problem — we handle it all.</p>
                <ul className="space-y-2 mb-6">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">Commercial pet waste management is about more than aesthetics — it is about liability, tenant satisfaction, and regulatory compliance. Unmanaged pet waste in shared spaces creates health risks and generates resident complaints. Professional, scheduled service is the most reliable solution.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Reduce resident complaints and protect property values with a consistent pet waste program. We handle scheduling, execution, and documentation — you handle everything else.</p>
                </div>
              ...
              {[
                {
                  ...
                  body: "A single gram of dog waste contains up to 23 million fecal coliform bacteria. Dog waste also commonly carries roundworms, hookworms, giardia, E. coli, and salmonella — many of which can infect humans, especially children who play on the ground."
                },
                {
                  title: "It damages your lawn",
                  body: "Dog waste is highly acidic and kills grass on contact, creating the brown dead spots you see in yards. Unlike cattle manure, dog waste is not a fertilizer — it is a toxin that degrades soil health and destroys turf over time."
                },
                {
        ...
        <section className="py-16 bg-primary/5 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-muted-foreground">— Ooltewah customer, weekly service since 2024</p>
          </div>
        </section>
