  ...
  const plans = [
    {
      ...
      description: "Our most popular option. We visit once a week and remove all waste from your yard â every time, without fail.",
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 px-4 bg-gradient-to-b from-primary/5 to-background text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-foreground mb-6 leading-tight">Dog Poop Removal &amp; Pet Waste Services in Chattanooga, TN</h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8">Weekly, bi-weekly, one-time, commercial, and HOA service â all with online quotes, on-the-way texts, and gate photo confirmation. No contracts, ever.</p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-card border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">Perfect for moving in or out, hosting an event, seasonal yard resets, or just trying us out before committing to regular service. Same thorough grid-pattern process as recurring visits â all waste removed from the property.</p>
              ...
              <div className="bg-card border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">If your yard has been unmanaged for weeks or months, we start with a thorough deep clean to get it back to baseline before beginning regular service. Overgrown yards and accumulated waste are never a problem â we handle it all.</p>
                <ul className="space-y-2 mb-6">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">Commercial pet waste management is about more than aesthetics â it is about liability, tenant satisfaction, and regulatory compliance. Unmanaged pet waste in shared spaces creates health risks and generates resident complaints. Professional, scheduled service is the most reliable solution.</p>
              ...
              <div className="bg-card border border-border rounded-2xl p-8">
                ...
                <ul className="space-y-4">
                  {[
                    { title: "Flexible scheduling", desc: "Daily, several times per week, or weekly â based on usage levels." },
        ...
        <section className="py-24 bg-background">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <SectionHeader icon={Sparkles} title="HOA & Apartment Pet Waste Stations" subtitle="We install, stock, and service pet waste stations so your community stays compliant and clean â with zero effort from management." />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div>
                <p className="text-muted-foreground leading-relaxed mb-6">Pet waste stations â the bag dispensers and waste receptacles you see in well-managed communities â are only effective if they are stocked and emptied consistently. Scoopy Doo provides full-service station management so HOA boards and property managers can set it and forget it.</p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Reduce resident complaints and protect property values with a consistent pet waste program. We handle scheduling, execution, and documentation â you handle everything else.</p>
                </div>
        ...
        <section className="py-24 bg-background">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <SectionHeader icon={AlertTriangle} title="Why Pet Waste Is a Health and Safety Issue" subtitle="Dog waste is not just unpleasant. It is classified by the EPA as a pollutant â and it creates real risks for your family." />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              {[
                {
                  title: "It carries dangerous pathogens",
                  body: "A single gram of dog waste contains up to 23 million fecal coliform bacteria. Dog waste also commonly carries roundworms, hookworms, giardia, E. coli, and salmonella â many of which can infect humans, especially children who play on the ground."
                },
                {
                  title: "It damages your lawn",
                  body: "Dog waste is highly acidic and kills grass on contact, creating the brown dead spots you see in yards. Unlike cattle manure, dog waste is not a fertilizer â it is a toxin that degrades soil health and destroys turf over time."
                },
                {
        ...
        <section className="py-16 bg-primary/5 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-muted-foreground">â Ooltewah customer, weekly service since 2024</p>
          </div>
        </section>
