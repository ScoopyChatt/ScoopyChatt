          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">Scoopy Doo LLC was founded by Leighton Carter, who started the business at 14 years old with a single customer. In under a year she grew it into Chattanooga's largest pet waste removal company, serving more than 150 active clients across Chattanooga and North Georgia. Her dad, Brandon, joined her early on to help run day-to-day operations, and the two have run Scoopy Doo together ever since as a true father-daughter team. Their story has been featured by the Chattanoogan and WDEF News 12.</p>
