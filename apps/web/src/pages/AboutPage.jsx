          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">Scoopy Doo LLC was co-founded by Brandon and Leighton Carter, a father-daughter team who started the business together with a single customer when Leighton was just 14 years old. In under a year they grew it into Chattanooga's largest pet waste removal company, serving more than 150 active clients across Chattanooga and North Georgia. Brandon and Leighton run every part of the business together to this day. Their story has been featured by the Chattanoogan and WDEF News 12.</p>
