...
const AboutPage = () => {
  ...
  const values = [
    ...
    { title: "We are genuinely local", body: "We live in the Chattanooga area. We know the neighborhoods, the terrain, and the community. This is not a franchise &mdash; it is our business and our reputation." },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        ...
        <meta name="description" content="Meet Scoopy Doo LLC &mdash; Chattanooga's locally owned father and daughter pet waste removal company. 80+ five-star reviews, two branded service vehicles, serving 17+ communities." />
        <link rel="canonical" href={canonicalUrl} />
        <meta property="og:title" content="About Scoopy Doo | Chattanooga Pet Waste Removal" />
        <meta property="og:description" content="Meet Scoopy Doo LLC &mdash; Chattanooga's locally owned father and daughter pet waste removal company." />
        ...
        <section className="py-16 bg-primary/5 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              {[
                { quote: "I have two big dogs and a small yard. Scoopy Doo shows up every week without fail &mdash; I literally never think about it anymore.", author: "Sarah M.", location: "Highland Park" },
