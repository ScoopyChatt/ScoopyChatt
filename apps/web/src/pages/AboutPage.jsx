...
const AboutPage = () => {
  ...
  const values = [
    { title: "We show up, every time", body: "Rain, cold, heat Ã¢ÂÂ we are on your route every scheduled week without exception. Our customers never have to wonder if we showed up." },
    ...
    { title: "We are genuinely local", body: "We live in the Chattanooga area. We know the neighborhoods, the terrain, and the community. This is not a franchise Ã¢ÂÂ it is our business and our reputation." },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        ...
        <meta name="description" content="Meet Scoopy Doo LLC Ã¢ÂÂ Chattanooga's locally owned father and daughter pet waste removal company. 80+ five-star reviews, two branded service vehicles, serving 17+ communities." />
        <link rel="canonical" href={canonicalUrl} />
        <meta property="og:title" content="About Scoopy Doo | Chattanooga Pet Waste Removal" />
        <meta property="og:description" content="Meet Scoopy Doo LLC Ã¢ÂÂ Chattanooga's locally owned father and daughter pet waste removal company." />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">Scoopy Doo LLC was founded by a Chattanooga father and daughter who saw a real need in their community Ã¢ÂÂ and decided to fill it. What started as a simple idea has grown into a service that hundreds of Chattanooga families rely on every week.</p>
                <p className="text-muted-foreground leading-relaxed mb-4">We run two branded service vehicles across 17+ communities in the Chattanooga metro area and North Georgia. Our team shows up in uniform, follows a systematic grid-pattern process on every yard, and never cuts corners Ã¢ÂÂ because this is our community too, and our name is on every truck.</p>
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-4">
                {/* Team photo Ã¢ÂÂ Chattanooga mural */}
                <div className="rounded-2xl overflow-hidden border border-border shadow-lg aspect-[4/3] bg-muted flex items-center justify-center">
                  <img
                    ...
                    alt="Scoopy Doo LLC owners Ã¢ÂÂ father and daughter team Ã¢ÂÂ in front of the Chattanooga Scenic City mural"
                  ...
                  <div style={{display:'none'}} className="w-full h-full items-center justify-center text-muted-foreground text-sm p-8 text-center">
                    <span>Father and daughter owners Ã¢ÂÂ Chattanooga, TN</span>
                  </div>
                </div>
        ...
        <section className="py-16 bg-primary/5 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              {[
                { quote: "I have two big dogs and a small yard. Scoopy Doo shows up every week without fail Ã¢ÂÂ I literally never think about it anymore.", author: "Sarah M.", location: "Highland Park" },
                ...
                <div key={i} className="bg-card border border-border rounded-2xl p-6">
                  ...
                  <div className="text-xs text-muted-foreground font-medium">{review.author} Ã¢ÂÂ {review.location}</div>
                </div>
              ))}
            </div>
            <div className="mt-8">
