    ...
    <main className="flex-grow py-20">
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-foreground space-y-6">
          ...
          <p>Unlike composted cow or horse manure, dog waste is highly acidic. Dogs are primarily carnivores, and their digestive systems produce waste with a very different chemical composition - one that burns rather than nourishes grass. The high nitrogen concentration in dog waste causes "nitrogen burn," creating the dead yellow and brown patches you may have noticed in spots your dog uses repeatedly.</p>
          ...
          <p>The EPA classifies dog waste as a dangerous non-point source pollutant - in the same category as toxic chemicals and oil spills. A single gram of dog feces can contain up to 23 million fecal coliform bacteria, including E. coli, Salmonella, and Campylobacter. These pathogens don't just sit on the surface. They leach into your soil and can remain viable for months or even years.</p>
          <p>Roundworm (Toxocara canis) eggs are particularly dangerous. They survive Chattanooga's mild winters and can infect humans through skin contact or accidental ingestion. Children playing in the yard - touching soil and then their faces - are at the highest risk. Hookworm larvae can also penetrate bare skin directly.</p>

          <h2 className="text-2xl font-bold mt-10 mb-4">Water Runoff: Leaving Your Yard Behind</h2>
          <p>Chattanooga receives over 50 inches of rain per year. Every rainfall event carries whatever is sitting in your yard into storm drains and eventually into local waterways - including Chattanooga Creek and the Tennessee River. Dog waste in that runoff contributes E. coli, giardia, and fecal coliform to water sources used for recreation and wildlife habitat.</p>
          <p>This isn't just a personal yard problem. It's a community environmental issue that responsible pet ownership - or professional removal - directly addresses.</p>
