  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        ...
        description="Dog poop doesn't just smell bad - it kills grass, spreads parasites, and pollutes local water. Here's what's actually happening in your Chattanooga yard."
      ...
      <main className="flex-grow py-20">
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            <p>Most Chattanooga dog owners think of yard cleanup as a chore they'd rather skip. But dog waste isn't just an unpleasant inconvenience - it's actively doing damage to your lawn, your soil, and the local environment. Here's what's actually going on under your feet.</p>

            <h2 className="text-2xl font-bold mt-10 mb-4">Myth: Dog Poop Is a Natural Fertilizer</h2>
            <p>This one gets repeated a lot, and it's mostly wrong. Cow and horse manure - when composted - can improve soil. Dog waste is different. Dogs are carnivores, and their waste is highly acidic and loaded with pathogens. It doesn't break down into useful nutrients. Instead, it introduces harmful bacteria and burns the grass directly where it sits.</p>
            ...
            <p>Dog poop contains high concentrations of nitrogen. A little nitrogen feeds grass. Too much - concentrated in the same spots week after week - causes "nitrogen burn," essentially scorching the roots. The result is dead patches that require reseeding, resodding, or months of recovery.</p>
            ...
            <p>This is the part most people don't think about. Long after the solid waste has broken down in rain or heat, the parasite eggs it contained remain viable in your soil - sometimes for months or even years.</p>
            ...
            <p>Chattanooga gets over 50 inches of rain per year. Every time it rains, whatever is sitting in your yard gets picked up and carried somewhere - into storm drains, into local creeks, and eventually into the Tennessee River and its tributaries.</p>
            <p>The EPA has classified dog waste as a non-point source pollutant, in the same category as fertilizer runoff and oil leaks. When waste runs off your yard, it carries E. coli, giardia, salmonella, and fecal coliform bacteria into water sources that other people - and other animals - use.</p>
            ...
            <p>Scoopy Doo serves Chattanooga and surrounding areas with weekly, bi-weekly, and one-time cleanup services. We walk your yard in a grid pattern - nothing gets missed - and haul the waste away entirely. Your grass stays green, your soil stays clean, and your kids can play outside without worry.</p>
