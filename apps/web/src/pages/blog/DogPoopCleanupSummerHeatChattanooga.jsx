      ...
      <main className="flex-grow py-20">
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            ...
            <p>The nitrogen overload that burns lawns happens more aggressively when the ground is hot. The heat speeds up the chemical reaction, and the result is those dead, brown patches that take weeks of watering and reseeding to recover from. For Chattanooga families in East Brainerd, Ooltewah, and Hixson, where yards get heavy afternoon sun, the damage can happen surprisingly fast. Weekly cleanup is not just cosmetic during summer &mdash; it is the only way to stay ahead of it.</p>
            ...
            <p>Chattanooga averages over 50 inches of rain per year, and summer brings intense afternoon thunderstorms that can dump inches of water in a short stretch. When that happens, whatever is sitting in your yard gets picked up and moved &mdash; into storm drains, into creek banks, and eventually into waterways like South Chickamauga Creek and the Tennessee River.</p>
            <p>This matters just as much for North Georgia neighbors in Ringgold, Fort Oglethorpe, and Rossville, which sit upstream of the same watershed. Dog waste runoff carries E. coli and other pathogens into shared water sources. Keeping your yard clean between summer storms protects local waterways &mdash; and it obviously matters for your own property too. The <a href="https://www.scoopychatt.com/" className="text-primary hover:underline">Scoopy Doo service area</a> covers both sides of the state line.</p>
