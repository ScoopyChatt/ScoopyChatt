...
const DogPoopRemovalPage = () => {
  return (
    <>
      <SEOHead path="/dog-poop-removal-chattanooga" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
                  ...
                  <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                    Reclaim your yard with our reliable, eco-friendly dog poop removal services. We handle the mess so you can enjoy a clean, safe outdoor space with your family and pets.
                  </p>
                ...
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.2 }} className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl">
                  <img src="https://horizons-cdn.hostinger.com/d0188638-a120-4cbd-8c61-d1420711a271/a31a7ef9578ab021774966b3677f99c1.jpg" alt="ScoopyChatt team providing dog poop removal services" className="w-full h-full object-cover" />
                </motion.div>
              </div>
            </div>
          </section>
