...
const YardCleanupPage = () => {
  return (
    <>
      <SEOHead path="/yard-cleanup-chattanooga" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
                  <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 text-balance">
                    Complete Yard Cleanup for Pet Owners
                  </h1>
                  <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                    Restore the beauty of your lawn with our comprehensive yard cleanup services. We specialize in removing pet waste to keep your grass healthy and your outdoor spaces inviting.
                  </p>
                  <ul className="space-y-4 mb-8">
                    {['Spring & Fall Deep Cleans', 'Routine Maintenance', 'Protects Lawn Health', 'Safe for Kids & Pets'].map((item, i) => (
                ...
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.2 }} className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl">
                  <img src="https://horizons-cdn.hostinger.com/d0188638-a120-4cbd-8c61-d1420711a271/8088ef4935a7739f1747caefac1fdcc6.jpg" alt="Yard cleanup services in Chattanooga" className="w-full h-full object-cover" />
                </motion.div>
              </div>
            </div>
          </section>
