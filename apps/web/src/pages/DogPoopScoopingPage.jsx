...
const DogPoopScoopingPage = () => {
  ...
  return (
    <>
      <SEOHead path="/dog-poop-scooping-chattanooga" faqData={faqs} />
        ...
        <main className="flex-1">
          ...
          <section className="py-20">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We scoop in Chattanooga, Hixson, Ooltewah, Signal Mountain, Red Bank, East Brainerd, East Ridge, Soddy-Daisy, and Collegedale, TN, plus Ringgold, Rossville, and Fort Oglethorpe, GA. Check your address when you request a free quote.
              </p>
            </div>
          </section>
