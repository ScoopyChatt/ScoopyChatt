...
const LocationTemplate = ({ city: propCity }) => {
      ...
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-grow flex items-center justify-center py-20">
          <div className="text-center flex flex-col items-center max-w-md px-4">
            ...
            <p className="text-muted-foreground mb-6">We couldn't find the service area you're looking for. We serve the greater Chattanooga area and North Georgia.</p>
            <Button asChild>
  ...
  const { name, seoTitle, seoDescription, serviceDescription, benefits, faqItems } = locationData;
            ...
            <div className="max-w-3xl">
              ...
              >
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6 text-balance" style={{ letterSpacing: '-0.02em' }}>
                  Pet Waste Removal Services in {name}
                </h1>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Why Choose Us in {name}?</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">We provide top-rated service tailored to your neighborhood's needs.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {benefits.map((benefit, index) => (
                <div key={index} className="bg-card p-6 rounded-2xl border border-border shadow-sm flex flex-col items-center text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-primary-foreground/80 text-lg">Fast scheduling available for your neighborhood.</p>
                </div>
              </div>
