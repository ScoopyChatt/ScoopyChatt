...
import * as ContextMenuPrimitive from &rdquo;@radix-ui/react-context-menu&rdquo;
...
const ContextMenuLabel = React.forwardRef(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label
    ref={ref}
    className={cn(
      &rdquo;px-2 py-1.5 text-sm font-semibold text-foreground&rdquo;,
      inset && &rdquo;pl-8&rdquo;,
      className
    )}
    {...props} />
...
const ContextMenuSeparator = React.forwardRef(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Separator
    ref={ref}
    className={cn(&rdquo;-mx-1 my-1 h-px bg-border&rdquo;, className)}
    {...props} />
))
...
ContextMenuShortcut.displayName = &rdquo;ContextMenuShortcut&rdquo;
