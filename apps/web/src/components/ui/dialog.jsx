...
import * as DialogPrimitive from &rdquo;@radix-ui/react-dialog&rdquo;
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      <DialogPrimitive.Close
        className=&rdquo;absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground&rdquo;>
...
const DialogHeader = ({
  ...
  <div
    className={cn(&rdquo;flex flex-col space-y-1.5 text-center sm:text-left&rdquo;, className)}
    {...props} />
)
DialogHeader.displayName = &rdquo;DialogHeader&rdquo;
...
DialogFooter.displayName = &rdquo;DialogFooter&rdquo;
