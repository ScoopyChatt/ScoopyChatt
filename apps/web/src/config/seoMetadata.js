...
export const seoMetadata = {
  ...
  "/pet-waste-removal-chattanooga": {
    title: "Pet Waste Removal in Chattanooga, TN | Scoopy Doo",
    description: "Expert pet waste removal in Chattanooga, TN for homes, HOAs & businesses. Keep your yard clean and safe. Request a free quote from Scoopy Doo.",
    canonical: `${CANONICAL_BASE_URL}/pet-waste-removal-chattanooga`,
    ogType: "website"
  },
  ...
  "/faq": {
    ...
    description: "Answers to common questions about dog poop removal in Chattanooga: pricing, scheduling, service areas, gate access, pets, and more.",
    canonical: `${CANONICAL_BASE_URL}/faq`,
    ogType: "website"
  },
  "/quote": {
    title: "Get a Free Pet Waste Removal Quote | Chattanooga, TN",
    description: "Get a fast, free quote for dog poop removal in Chattanooga, TN. Tell us your yard size and number of dogs and we'll send pricing right away.",
  ...
  "/doggy-doors": {
    ...
    image: "https://www.scoopychatt.com/images/doggy-doors-hero.png",
    ogType: "website"
  },
  "/privacy-policy": {
